...
var dataPicker = document.querySelector('input[type="text"]');
var startButton = document.querySelector('button[data-start]');
var daysRef = document.querySelector('.value[data-days]');
var hoursRef = document.querySelector('.value[data-hours]');
var minutesRef = document.querySelector('.value[data-minutes]');
var secondsRef = document.querySelector('.value[data-seconds]');
var date = new Date();
var time = null;
var isActive = false;
var interval = null;
...
(0, _flatpickr.default)(dataPicker, options);
...
function convertMs(ms) {
  ...
  var days = padTwoSymbols(Math.floor(ms / day)); // Remaining hours

  var hours = padTwoSymbols(Math.floor(ms % day / hour)); // Remaining minutes

  var minutes = padTwoSymbols(Math.floor(ms % day % hour / minute)); // Remaining seconds

  var seconds = padTwoSymbols(Math.floor(ms % day % hour % minute / second));
  return {
    days: days,
    hours: hours,
    minutes: minutes,
